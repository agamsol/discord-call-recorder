...
def create_logger(log_date_format: str, logs_directory: str, log_level: str, logger_name: str, alias: str) -> logging.Logger:
    ...
    # FILE HANDLER
    file_handler = DailyFileHandler(logs_directory, backupCount=7, encoding='utf-8')
